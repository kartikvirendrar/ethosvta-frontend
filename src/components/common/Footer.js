...
export default function Footer() {
    return (
        <>
            <footer className="bg-white shadow-inner border-t border-white dark:bg-gray-900">
                <div className="container p-6 pb-4 mx-auto">
                    <div className="lg:flex">
                        <div className="w-full -mx-6 lg:w-1/2">
                            <div className="px-6">
                                <div>
                                    <a href="/" className="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">ETHOS - Video To Audio</a>
                                </div>

                                <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400">Multimedia tool to convert video to audio and do lot more</p>

                                <div className="flex mt-6 -mx-2">
                                    <a href="https://github.com/kartikvirendrar" target="blank"
                    ...
                    <div>
                        <p className="text-center text-gray-500 dark:text-gray-400">© EthosVTA 2023 - All rights reserved</p>
                    </div>
                </div>
            </footer>
        </>
